      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="w-8 h-6 text-accent relative 
          flex items-center justify-center z-[60] outline-none"
          >
            {/* 1 */}
            <span
              className={`w-full h-[1.5px] bg-current absolute 
            left-0 will-change-transform transition-transform duration-300 ${
